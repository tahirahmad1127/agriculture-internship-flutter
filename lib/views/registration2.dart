                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value){
                          ...
                          if (!RegExp(r'^0\d{10}$').hasMatch(value.trim())) {
                            return 'Contact number must start with 0 and be 11 digits';
                          }
                          return null;
                        },
                        decoration: InputDecoration(
                    ...
                    onPressed: () async{
                      ...
                      if(selectedValue == null){
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text("Please select your expertise")),
                        );
                        return;
                      }
                      ...
                      if (degreeImageUrl == null) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('Please upload your degree image')),
                        );
                        return;
                      }
