              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding:  EdgeInsets.only(top: Screen_height * 0.06, left: Screen_width * 0.06, right: Screen_width * 0.06),
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: "Label",labelStyle: GoogleFonts.raleway(
                                fontSize:11,
                                fontWeight: FontWeight.w400,
                                color: Color(0xffB4B4B4)
                            ),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: "Password",labelStyle: GoogleFonts.raleway(
                                fontSize:11,
                                fontWeight: FontWeight.w400,
                                color: Color(0xffB4B4B4)
                            ),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: "Confirm Password", hintStyle: GoogleFonts.raleway(
                                fontSize:13,
                                fontWeight: FontWeight.w400,
                                color: Color(0xffB4B4B4)
                            ),
                              labelText: "Confirm Password",labelStyle: GoogleFonts.raleway(
                                fontSize:11,
                                fontWeight: FontWeight.w400,
                                color: Color(0xffB4B4B4)
                            ),
