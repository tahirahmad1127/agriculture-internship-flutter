        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("Help in Market Analysis",
            ...
            Padding(
              padding:  EdgeInsets.symmetric(horizontal: Screen_width * 0.05),
              child: Text("You’ll have all of the market ananlysis in your pocket. You’ll get to know the latest and Genuine Market Rates of items.",
                style: GoogleFonts.raleway(
